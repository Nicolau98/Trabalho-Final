...
namespace Trabalho_Final
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<Trabalho_FinalContext>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("Trabalho_FinalContext")));
        }

        // This method gets called by the runtime. Use this method to configure the HTTP request pipeline.
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env,
            Trabalho_FinalContext bd,
            ...
            RoleManager<IdentityRole> gestorRoles)
        {
            ...
            //if (env.IsDevelopment())
            //{
            //    SeedData.PreencheDadosLojaFicticia(bd);
